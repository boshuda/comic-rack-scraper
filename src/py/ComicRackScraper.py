...
This module is the entry point into the 'Comic Rack Scraper' add-on for 
...
License: 
   ...
   The Comic Rack Scraper add-on is licensed under the Apache 2.0 software 
   license, available at: http://www.apache.org/licenses/LICENSE-2.0.html

       
Credits:
   The add-on has been forked/branched/cloned from the Comic Vine Scraper by Cory 
   Banack.  It is being maintained by Craig Hornsby.
